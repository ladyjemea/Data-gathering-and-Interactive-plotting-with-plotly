...
ttoday = dtm.date.today()
yesterday = ttoday - dtm.timedelta(days=1)
...
url_jan = "http://flux.phys.uit.no/cgi-bin/mkascii.cgi?site=rjan1a&year="+year+"&month="+month+"&day="+day+"&res=60sec&pwd=&format=html&comps=DHZ&getdata=+Get+Data+"
...
try:
    ...
    #dfTro.to_csv('Magnetometer/data/threshold_mag_tro.csv', index= True, sep= " ")

    with open('Magnetometer/data/magnetometer_tro.csv', 'a')as f:
        if os.path.getsize('Magnetometer/data/magnetometer_tro.csv') <= 0:
            dfTro.to_csv(f, header=f.tell()==0, index = True, sep = " ")
        elif os.path.getsize('Magnetometer/data/magnetometer_tro.csv') > 0:
            df1 = pd.read_csv('Magnetometer/data/magnetometer_tro.csv', sep = " ")
            df1['timestamp'] = pd.to_datetime(df1['timestamp'])
            df1.set_index('timestamp', inplace=True)
            if dtm.datetime.utcnow() > df1.index[-2]:
                values = dfTro.index > df1.index[-2]
                df1 = dfTro[values]
                df1.to_csv('Magnetometer/data/magnetometer_tro.csv', mode='a', index =True, sep = " ", header = False)
    f.close()

    #ACTIVITY INDEX TROMSØ
    dfTro = pd.read_csv('Magnetometer/data/magnetometer_tro.csv', sep = " ")
    ...
    dfTro_ai.to_csv('Magnetometer/data/ai/Tro.csv', sep = " ")
except:
    pass
...
try:
    ...
    dfAnd.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfHop.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfBjn.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfNor.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfSor.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfDon.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfJck.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfRvk.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfSol.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfKar.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfJan.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfMas.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfRst.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfHar.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfIva.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfMuo.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfSod.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfPel.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfOuj.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfMek.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfHan.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfNur.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfTar.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfKev.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfKil.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfRan.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    dfKir.drop(['Date', 'Time', 'Dec', 'Vert', 'Incl', 'Tot'], axis = 1, inplace = True)
...
try:
    ...
    with open('Solar_wind/data/Speed.csv', 'a')as f:
        if os.path.getsize('Solar_wind/data/Speed.csv') <= 0:
            dfS.to_csv(f, header=f.tell()==0, index =True, sep = " ")
        elif os.path.getsize('Solar_wind/data/Speed.csv') > 0:
            df1 = pd.read_csv('Solar_wind/data/Speed.csv', sep = " ")
            df1['timestamp'] = pd.to_datetime(df1['timestamp'])
            df1.set_index('timestamp', inplace=True)
            if dtm.datetime.utcnow().replace(microsecond=0) > df1.index[-1]:
                values = dfS.index > df1.index[-1]
                df1 = dfS[values]
                df1.to_csv('Solar_wind/data/Speed.csv', mode='a', index =True, sep = " ", header = False)
    f.close()
except:
    pass
...
try:
    ...
    dfX['Xrays'] =[float('{:.3g}'.format(x)) for x in dfX['Xrays']]
...
#Google Analytics code on NOSWE website
#UA-54918607-1